          ...
          <div class="card-flat padding" :class="determineLabelColor" v-else>
            ...
            <form @action="submit" v-if="config">
              ...
              <div v-if="config.connectionType">
                ...
                />
                <firestore-form
                  v-else-if="config.connectionType === 'firestore'"
                  :config="config"
                  :testing="testing"
                />
...
import FirestoreForm from './connection/FirestoreForm.vue'
