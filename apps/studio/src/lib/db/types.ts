...
export const IamAuthTypes = [
  {
    name: "IAM Authentication Using Access Key and Secret Key",
    value: IamAuthType.Key,
  },
  {
    name: "IAM Authentication Using Credentials File",
    value: IamAuthType.File,
  },
...
export const AzureAuthTypes = [
  ...
  // { name: 'MSI VM', value: AzureAuthType.MSIVM },
  {
    ...
    value: AzureAuthType.ServicePrincipalSecret,
  },
...
export interface IBasicDatabaseClient {
  ...
  getMaterializedViewCreateScript(
    view: string,
    schema?: string
  ): Promise<string[]>;
  ...
  importTruncateCommand(
    table: TableOrView,
    importOptions?: ImportFuncOptions
  ): Promise<any>;
  importLineReadCommand(
    table: TableOrView,
