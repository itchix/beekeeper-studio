...
import { AzureCredsEncryptTransformer, EncryptTransformer, SurrealDbEncryptTransformer, FirestoreEncryptTransformer } from '../transformers/Transformers'
import { IConnection, SshMode } from '@/common/interfaces/IConnection'
import { AzureAuthOptions, BigQueryOptions, CassandraOptions, ConnectionType, ConnectionTypes, LibSQLOptions, RedshiftOptions, IamAuthOptions, SQLAnywhereOptions, SurrealDBOptions, FirestoreOptions } from "@/lib/db/types"
...
const firestoreEncrypt = new FirestoreEncryptTransformer(loadEncryptionKey())
...
export class DbConnectionBase extends ApplicationEntity {
  ...
  @Column({ type: 'simple-json', nullable: false, transformer: [firestoreEncrypt] })
